...
def build_session_style_rules():
    return [
        ...
        ("transcript.error.compile_error.prefix", "bold ansired"),
        ("transcript.error.compile_error.text", "ansired"),
        ("transcript.error.runtime_error.prefix", "bold ansired"),
        ("transcript.error.runtime_error.text", "ansired"),
        ("transcript.error.builtin_error.prefix", "bold ansired"),
        ("transcript.error.builtin_error.text", "ansired"),
        ("transcript.error.action_required.text", "bold ansiblack bg:ansiyellow"),
        ("transcript.error.timeout_error.prefix", "bold ansired"),
        ("transcript.error.timeout_error.text", "ansired"),
        ("transcript.error.connection_error.prefix", "bold ansired"),
        ("transcript.error.connection_error.text", "ansired"),
        ("transcript.error.transport_error.prefix", "bold ansired"),
        ("transcript.error.transport_error.text", "ansired"),
        ("transcript.error.command_error.prefix", "bold ansired"),
        ("transcript.error.command_error.text", "ansired"),
    ]
